          ...
          <div className="row justify-content-center d-flex">
            <div className="col-12 col-md-6 col-lg-4 ">
              <div className="card my-4 px-4">
                ...
                <span className="text-center pb-3 text-yellow"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i></span>
